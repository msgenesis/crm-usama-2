...
class AllSell extends Component {
    ...
    updateDeal() {
        let { fullName, phone, phone2, cell, address, city, state, zipCode, Notes,
            ...
            Designation, Education, OtherLoan, CloserNotes, lastPayDate, duePayDate } = this.state;
        // var is_valid = luhn.validate(cc);
        if (cc === " " && this.state.data.cardDetail === "") {
            let deal = {
                ...
                CloserNotes: CloserNotes === " " ? this.state.data.CloserNotes === undefined ? "nill" : this.state.data.CloserNotes : CloserNotes,
                status: {
                    ...
                    transferCloserName: this.state.data.status.transferCloserName,
                    transferAgentID: this.state.data.status.transferAgentID,
                    transferAgentName: this.state.data.status.transferAgentName,
                    statusCloser: this.state.oldSSNList.indexOf(ssn) !== - 1 || this.state.oldPhoneList.indexOf(phone) !== -1 ? "Dublicated" : this.state.data.status.statusCloser,
            ...
            console.log("Testingg=====>>>", duePayDate === " " || duePayDate === "" ? this.state.data.cardDetail[cardIndex].duePayDate : duePayDate)
    ...
    render() {
        ...
        let { fullName, phone, phone2, cell, address, city, state,
            ...
            AnnualIncome, CloserNotes, duePayDate, lastPayDate } = this.state;
         let user = {};
        return (
                                        ...
                                        {this.state.data.map((v, i) => {
                                            ...
                                            return (
                                                <tr key={i}>
                                                    <td>{v._id}</td>
                                                    <td>{v.FullName}</td>
                                                    <td>{v.status === "Transfer" || v.status === "Dublicated" ? <b>✦✦✦✦✦✦✦✦✦✦</b> : v.phone}</td>
                                                    <td>{v.Time}</td>
                                                    <td>{v.createdAt}</td>
                                                    <td title={v.status === "Call Back" ? v.status.callbackDate + " " + v.status.callbackTime : ""}>
                                                    ...
                                                    <td>
                                                        {v.Status.statusAdmin === "Dublicated" ?
                                                ...
                                                this.state.data.card === false
                                                    ...
                                                    <div>
                                                        <Table responsive bordered style={{ textAlign: "center" }}>
                                                            <thead>
                                                                <tr>
                                                                    <th colSpan="2"><b><i className="fa fa-date"></i> {this.state.data.date}</b></th>
                                                                    <th colSpan="2"><b><i className="fa fa-time"></i> {this.state.data.time}</b></th>
                                                                </tr>
                                                                <tr>
                                                            ...
                                                            <tbody>
                                                                            ...
                                                                            <Col xs="12">
                                                                                <Col xs="12">
                                                                                    <FormGroup>
                                                                                        ...
                                                                                        <NumberFormat style={{ backgroundColor: "#e4e7ea" }} disabled displayType={'input'} className="format" format="################" id="cc" placeholder="Credit Card Number" value={cc.trim() === "" ? this.state.data.cardDetail[this.state.cardIndex].cc : cc} onBlur={this.handleBlur.bind(this)} onChange={e => this.setState({ cc: e.target.value })} />
                                                                                        {this.state.ccError === "" ?
                                                                                            null
                                                                                            :
                                                                                ...
                                                                                <Col xs="12">
                                                                                    <FormGroup>
                                                                                        ...
                                                                                        <span style={{ backgroundColor: "#e4e7ea" }} className="format" disabled> {this.state.data.cardDetail[this.state.cardIndex].nameOnCard}</span>
                                                                                    </FormGroup>
                                                                                </Col>
                                                                                <Col xs="12">
                                                                                    <FormGroup row className="my-0">
                                                                                        <Col xs="6">
                                                                                            <FormGroup>
                                                                                                ...
                                                                                                <span style={{ backgroundColor: "#e4e7ea" }} className="format" disabled> {this.state.data.cardDetail[this.state.cardIndex].cvc}</span>
                                                                                            </FormGroup>
                                                                                        </Col>
                                                                                        <Col xs="6">
                                                                                            <FormGroup>
                                                                                                <Label htmlFor="country">Exp#</Label>
                                                                                                <NumberFormat style={{ backgroundColor: "#e4e7ea" }} disabled format={this.cardExpiry} className="format" id="exp" placeholder="CC Expiration" value={exp.trim() === "" ? this.state.data.cardDetail[this.state.cardIndex].exp : exp} onChange={e => this.setState({ exp: e.target.value })} />
                                                                ...
                                                                <tr>
                                                                    <td><b>Phone</b></td>
                                                                    <td>
                                                                        <NumberFormat format="+# (###) ###-####" style={{ borderColor: this.state.phoneBorder }} className="format" value={phone === " " ? this.state.data.phone : phone} onChange={e => this.setState({ phone: e.target.value })} onBlur={this.findPhone.bind(this)} />
                                                                ...
                                                                <tr>
                                                                    <td><b>Cell</b></td>
                                                                    <td><NumberFormat className="format" value={cell.trim() === "" ? this.state.data.cell === " " ? "Not Provided" : this.state.data.cell : cell} onChange={e => this.setState({ cell: e.target.value })} /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td><b>Address</b></td>
                                                                    <td><input type="text" className="format" value={address.trim() === "" ? this.state.data.address : address} onChange={e => this.setState({ address: e.target.value })} /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td><b>City</b></td>
                                                                    <td><input type="text" className="format" value={city.trim() === "" ? this.state.data.city : city} onChange={e => this.setState({ city: e.target.value })} /></td>
                                                                    <td><b>Bank Name</b></td>
                                                                    <td><input type="text" className="format" value={bankName.trim() === "" ? this.state.data.cardDetail[this.state.cardIndex].bankName : bankName} onChange={e => this.setState({ bankName: e.target.value })} /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td><b>State</b></td>
                                                                    <td><input type="text" className="format" value={state === "" ? this.state.data.state : state} onChange={e => this.setState({ state: e.target.value })} /></td>
                                                                    <td><b>Bank Number</b></td>
                                                                    <td><NumberFormat className="format" value={bankNumber.trim() === "" ? this.state.data.cardDetail[this.state.cardIndex].bankNumber === "" ? "Not Provided" : this.state.data.cardDetail[0].bankNumber : bankNumber} onChange={e => this.setState({ bankNumber: e.target.value })} /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td><b>Zip Code</b></td>
                                                                    <td><NumberFormat className="format" value={zipCode.trim() === "" ? this.state.data.zipCode : zipCode} onChange={e => this.setState({ zipCode: e.target.value })} /></td>
                                                                    <td><b>Balance</b></td>
                                                                    <td><NumberFormat className="format" prefix={'$'} thousandSeparator={true} value={bal.trim() === "" ? this.state.data.cardDetail[this.state.cardIndex].bal : bal} onChange={e => this.setState({ bal: e.target.value })} /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td><b>Email</b></td>
                                                                    <td><input type="text" className="format" value={email === " " ? this.state.data.email === "" ? "Not Provided" : this.state.data.email : email} onChange={e => this.setState({ email: e.target.value })} /></td>
                                                                    <td><b>Available</b></td>
                                                                    <td><NumberFormat className="format" prefix={'$'} thousandSeparator={true} value={aval === " " ? this.state.data.cardDetail[this.state.cardIndex].aval : aval} onChange={e => this.setState({ aval: e.target.value })} /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td><b>DOB</b></td>
                                                                    <td><input type="date" className="format" value={dob === " " ? this.state.data.dob : dob} onChange={e => this.setState({ dob: e.target.value })} /></td>
                                                                    <td><b>Last Pay</b></td>
                                                                    <td>
                                                                        <NumberFormat className="format" prefix={'$'} thousandSeparator={true} value={lastPay === " " ? this.state.data.cardDetail[this.state.cardIndex].lastPay : lastPay} onChange={e => this.setState({ lastPay: e.target.value })} />
                                                                        <NumberFormat className="format" format="##/##" placeholder="MM/DD" value={lastPayDate === " " ? this.state.data.cardDetail[this.state.cardIndex].lastPayDate : lastPayDate} onChange={e => this.setState({ lastPayDate: e.target.value })} />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td><b>MMN</b></td>
                                                                    <td><input type="text" className="format" value={mmn === " " ? this.state.data.mmn : mmn} onChange={e => this.setState({ mmn: e.target.value })} /></td>
                                                                    <td><b>Due Pay</b></td>
                                                                    <td><NumberFormat className="format" prefix={'$'} thousandSeparator={true} value={duePay === " " ? this.state.data.cardDetail[this.state.cardIndex].duePay : duePay} onChange={e => this.setState({ duePay: e.target.value })} />
                                                                        <NumberFormat className="format" format="##/##" placeholder="MM/DD" value={duePayDate === " " ? this.state.data.cardDetail[this.state.cardIndex].duePayDate : duePayDate} onChange={e => this.setState({ duePayDate: e.target.value })} />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td><b>SSN</b></td>
                                                                    <td>
                                                                        <NumberFormat format="###-##-####" style={{ borderColor: this.state.SSNBorder }} className="format" value={ssn === " " ? this.state.data.ssn : ssn} onChange={e => this.setState({ ssn: e.target.value })} onBlur={() => { if (this.state.oldSSNList.indexOf(ssn) !== -1) { this.setState({ SSNBorder: '#c62828', SSNError: "This SSN already used please contact to admin" }) } }} />
                                                                        {this.state.SSNError === "" ?
                                                                            null
                                                                            :
                                                                    ...
                                                                    <td><NumberFormat className="format" format="##.##%" value={aprl === " " ? this.state.data.cardDetail[this.state.cardIndex].aprl : aprl} onChange={e => this.setState({ aprl: e.target.value })} /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td><b>Phone2</b></td>
                                                                    <td><NumberFormat format="+# (###) ###-####" className="format" value={phone2 === " " ? this.state.data.phone2 : phone2} onChange={e => this.setState({ phone2: e.target.value })} /></td>
                                                                    <td colSpan="2">
                                                                        {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colSpan="2"><input type="text" className="format" style={{ borderColor: this.state.SecurityWordBorder, backgroundColor: this.state.SecurityWordBackground }} value={SecurityWord === " " ? this.state.data.otherDetail.SecurityWord : SecurityWord} onChange={e => this.setState({ SecurityWord: e.target.value, SecurityWordBorder: "", SecurityWordBackground: "" })} onBlur={() => { if (SecurityWord.length> 1 || this.state.data.otherDetail.SecurityWord.length> 1) { this.setState({ SecurityWordBorder: 'green', SecurityWordBackground: "#d4eed8" }) } else { this.setState({ SecurityWordBorder: 'red', SecurityWordBackground: "#f6e0df" }) } }} /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td colSpan="2"><b>Highest Level Edu</b></td>
                                                                    <td colSpan="2">
                                                                        <select className="format" value={Education === "Select" ? this.state.data.otherDetail.Education : Education} style={{ borderColor: this.state.EducationBorder, backgroundColor: this.state.EducationBackground }} onChange={e => this.setState({ Education: e.target.value, EducationBorder: "", EducationBackground: "" })} onBlur={() => { if (Education !== "Select" || this.state.data.otherDetail.Education !== "") { this.setState({ EducationBorder: 'green', EducationBackground: "#d4eed8" }) } else { this.setState({ EducationBorder: 'red', EducationBackground: "#f6e0df" }) } }}>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colSpan="2">
                                                                        <select className="format" value={EmploymentStatus === "Select" ? this.state.data.otherDetail.EmploymentStatus : EmploymentStatus} style={{ borderColor: this.state.EmploymentStatusBorder, backgroundColor: this.state.EmploymentStatusBackground }} onChange={e => this.setState({ EmploymentStatus: e.target.value, EmploymentStatusBorder: "", EmploymentStatusBackground: "" })} onBlur={() => { if (EmploymentStatus !== "Select" || this.state.data.otherDetail.EmploymentStatus !== "") { this.setState({ EmploymentStatusBorder: 'green', EmploymentStatusBackground: "#d4eed8" }) } else { this.setState({ EmploymentStatusBorder: 'red', EmploymentStatusBackground: "#f6e0df" }) } }}>
                                                                            {/* <option value="Select">Select</option>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colSpan="2">
                                                                        <select className="format" value={HousingStatus === "Select" ? this.state.data.otherDetail.HousingStatus : HousingStatus} style={{ borderColor: this.state.HousingStatusBorder, backgroundColor: this.state.HousingStatusBackground }} onChange={e => this.setState({ HousingStatus: e.target.value, HousingStatusBorder: "", HousingStatusBackground: "" })} onBlur={() => { if (HousingStatus !== "Select" || this.state.data.otherDetail.HousingStatus !== "") { this.setState({ HousingStatusBorder: 'green', HousingStatusBackground: "#d4eed8" }) } else { this.setState({ HousingStatusBorder: 'red', HousingStatusBackground: "#f6e0df" }) } }}>
                                                                            {/* <option value="Select">Select</option>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colSpan="2"><input type="text" style={{ borderColor: this.state.CompanyBorder, backgroundColor: this.state.CompanyBackground }} className="format" value={Company === " " ? this.state.data.otherDetail.Company : Company} onChange={e => this.setState({ Company: e.target.value, CompanyBorder: "", CompanyBackground: "" })} onBlur={() => { if (Company.length> 1 || this.state.data.otherDetail.Company !== "") { this.setState({ CompanyBorder: 'green', CompanyBackground: "#d4eed8" }) } else { this.setState({ CompanyBorder: 'red', CompanyBackground: "#f6e0df" }) } }} /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td colSpan="2"><b>Designation</b></td>
                                                                    <td colSpan="2"><input type="text" className="format" style={{ borderColor: this.state.DesignationBorder, backgroundColor: this.state.DesignationBackground }} value={Designation === " " ? this.state.data.otherDetail.Designation : Designation} onChange={e => this.setState({ Designation: e.target.value, DesignationBackground: "", DesignationBorder: "" })} onBlur={() => { if (Designation.length> 1 || this.state.data.otherDetail.Designation !== "") { this.setState({ DesignationBorder: 'green', DesignationBackground: "#d4eed8" }) } else { this.setState({ DesignationBorder: 'red', DesignationBackground: "#f6e0df" }) } }} /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td colSpan="2"><b>Annual income</b></td>
                                                                    <td colSpan="2"><NumberFormat displayType={'input'} placeholder="Annual income" thousandSeparator={true} prefix={'$'} style={{ borderColor: this.state.AnnualIncomeBorder, backgroundColor: this.state.AnnualIncomeBackground }} className="format" value={AnnualIncome === " " ? this.state.data.otherDetail.AnnualIncome : AnnualIncome} onChange={e => this.setState({ AnnualIncome: e.target.value, AnnualIncomeBorder: "", AnnualIncomeBackground: "" })} onBlur={() => { if (AnnualIncome.length> 1 || this.state.data.otherDetail.AnnualIncome !== "") { this.setState({ AnnualIncomeBorder: 'green', AnnualIncomeBackground: "#d4eed8" }) } else { this.setState({ AnnualIncomeBorder: 'red', AnnualIncomeBackground: "#f6e0df" }) } }} /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td colSpan="2"><b>Chequin Accounts</b></td>
                                                                    <td colSpan="2">
                                                                        <select className="format" value={ChequinAccount === "Select" ? this.state.data.otherDetail.ChequinAccount : ChequinAccount} style={{ borderColor: this.state.ChequinAccountBorder, backgroundColor: this.state.ChequinAccountBackground }} onChange={e => this.setState({ ChequinAccount: e.target.value, ChequinAccountBorder: "", ChequinAccountBackground: "" })} onBlur={() => { if (ChequinAccount !== "Select" || this.state.data.otherDetail.ChequinAccount !== "") { this.setState({ ChequinAccountBorder: 'green', ChequinAccountBackground: "#d4eed8" }) } else { this.setState({ ChequinAccountBorder: 'red', ChequinAccountBackground: "#f6e0df" }) } }}>
                                                                            {/* <option value="Select">Select</option>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colSpan="2">
                                                                        <select className="format" value={OtherLoan === "Select" ? this.state.data.otherDetail.OtherLoan : OtherLoan} style={{ borderColor: this.state.OtherLoanBorder, backgroundColor: this.state.OtherLoanBackground }} onChange={e => this.setState({ OtherLoan: e.target.value, OtherLoanBorder: "", OtherLoanBackground: "" })} onBlur={() => { if (OtherLoan !== "Select" || this.state.data.otherDetail.OtherLoan !== "") { this.setState({ OtherLoanBorder: 'green', OtherLoanBackground: "#d4eed8" }) } else { this.setState({ OtherLoanBorder: 'red', OtherLoanBackground: "#f6e0df" }) } }}>
                                                                            {/* <option value="Select">Select</option>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colSpan="2"><NumberFormat displayType={'input'} placeholder="Monthly Rent/Mortgage" thousandSeparator={true} prefix={'$'} style={{ borderColor: this.state.MonthlyMortgagesBorder, backgroundColor: this.state.MonthlyMortgagesBackground }} className="format" value={MonthlyMortgages === " " ? this.state.data.otherDetail.MonthlyMortgages : MonthlyMortgages} onChange={e => this.setState({ MonthlyMortgages: e.target.value, MonthlyMortgagesBorder: "", MonthlyMortgagesBackground: "" })} onBlur={() => { if (MonthlyMortgages.length> 1 || this.state.data.otherDetail.MonthlyMortgages !== "") { this.setState({ MonthlyMortgagesBorder: 'green', MonthlyMortgagesBackground: "#d4eed8" }) } else { this.setState({ MonthlyMortgagesBorder: 'red', MonthlyMortgagesBackground: "#f6e0df" }) } }} /></td>
                                                                </tr>
                                                    ...
                                                    <div>
                                                        <Table responsive bordered style={{ textAlign: "center" }}>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td><b>Full Name</b></td>
                                                                    <td><input type="text" className="format" value={fullName === " " ? this.state.data.fullName : fullName} onChange={e => this.setState({ fullName: e.target.value })} /></td>
                                                                    <td colSpan="2" rowSpan="4">
                                                                        <FormGroup row className="my-0">
                                                                            <Col xs="12">
                                                                                <Col xs="12">
                                                                ...
                                                                <tr>
                                                                    <td><b>Phone</b></td>
                                                                    <td>
                                                                        <NumberFormat format="+# (###) ###-####" style={{ borderColor: this.state.phoneBorder }} className="format" value={phone === " " ? this.state.data.phone : phone} onChange={e => this.setState({ phone: e.target.value })} onBlur={() => { if (this.state.oldPhoneList.indexOf(phone) !== -1) { this.setState({ phoneBorder: '#c62828', phoneError: "This Phone already used please contact to admin" }) } }} />
                                                                        {this.state.phoneError === "" ?
                                                                            null
                                                                            :
                                                                            <small style={{ color: 'red', float: 'right' }}>{this.state.phoneError}</small>
                                                                ...
                                                                <tr>
                                                                    <td><b>Cell</b></td>
                                                                    <td><NumberFormat className="format" value={cell === " " ? this.state.data.cell === "" ? "Not Provided" : this.state.data.cell : cell} onChange={e => this.setState({ cell: e.target.value })} /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td><b>Address</b></td>
                                                                    <td><input type="text" className="format" value={address === " " ? this.state.data.address : address} onChange={e => this.setState({ address: e.target.value })} /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td><b>City</b></td>
                                                                    <td><input type="text" className="format" value={city === " " ? this.state.data.city : city} onChange={e => this.setState({ city: e.target.value })} /></td>
                                                                    <td><b>Bank Name</b></td>
                                                                ...
                                                                <tr>
                                                                    <td><b>Zip Code</b></td>
                                                                    <td><NumberFormat className="format" value={zipCode === " " ? this.state.data.zipCode : zipCode} onChange={e => this.setState({ zipCode: e.target.value })} /></td>
                                                                    <td><b>Balance</b></td>
                                                    ...
                                                    {this.state.data.card === true
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td colSpan="2" rowSpan="5" onClick={() => { if (this.state.focused === "cc") { this.setState({ focused: "cvc" }) } else { this.setState({ focused: "cc" }) } }}> <Cards
                                                                        number={this.state.viewSale.cardDetail[this.state.cardIndex].cc}
                                                                        name={this.state.viewSale.cardDetail[this.state.cardIndex].nameOnCard}
                                                                        expiry={this.state.viewSale.cardDetail[this.state.cardIndex].exp}
                                                                        cvc={this.state.viewSale.cardDetail[this.state.cardIndex].cvc}
                                                                        focused={this.state.focused}
                                                                    /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td><b>Phone</b></td>
                                                                    <td>{this.state.viewSale.phone}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td><b>Cell</b></td>
                                                                    <td>{this.state.data.cell === "" ? "Not Provided" : this.state.data.phone}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td><b>Address</b></td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><b>Bank Name</b></td>
                                                                    <td>{this.state.data.cardDetail[this.state.cardIndex].bankName}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td><b>Zip Code</b></td>
                                                                    <td>{this.state.data.zipCode}</td>
                                                                    <td><b>Bank Number</b></td>
                                                                    <td>{this.state.data.cardDetail[this.state.cardIndex].bankNumber === "" ? "Not Provided" : this.state.data.cardDetail[this.state.cardIndex].bankNumber}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td><b>Email</b></td>
                                                                    <td>{this.state.data.email === "" ? "Not Provided" : this.state.data.email}</td>
                                                                    <td><b>Balance</b></td>
                                                                    <td>{this.state.data.cardDetail[this.state.cardIndex].bal}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td><b>DOB</b></td>
                                                                    <td>{this.state.data.dob}</td>
                                                                    <td><b>Available</b></td>
                                                                    <td>{this.state.data.cardDetail[this.state.cardIndex].aval}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td><b>MMN</b></td>
                                                                    <td>{this.state.data.mmn}</td>
                                                                    <td><b>Last Pay</b></td>
                                                                    <td>{this.state.data.cardDetail[this.state.cardIndex].lastPay}{" "}{"→"}{" "}{this.state.data.cardDetail[this.state.cardIndex].lastPayDate}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td><b>SSN</b></td>
                                                                    <td>{this.state.data.ssn}</td>
                                                                    <td><b>Due Pay</b></td>
                                                                    <td>{this.state.data.cardDetail[this.state.cardIndex].duePay}{" "}{"→"}{" "}{this.state.data.cardDetail[this.state.cardIndex].duePayDate}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td><b>Phone2</b></td>
                                                                    <td>{this.state.data.phone2}</td>
                                                                    <td><b>Aprl</b></td>
                                                                    <td>{this.state.data.cardDetail[this.state.cardIndex].aprl}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td></td>
                                                                    <td></td>
                                                                ...
                                                                <tr>
                                                                    <td colSpan="2"><b>SecurityWord</b></td>
                                                                    <td colSpan="2">{this.state.data.otherDetail.SecurityWord}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td colSpan="2"><b>Highest Level Edu</b></td>
                                                                    <td colSpan="2">{this.state.data.otherDetail.Education}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td colSpan="2"><b>Employment Status</b></td>
                                                                    <td colSpan="2">{this.state.data.otherDetail.EmploymentStatus}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td colSpan="2"><b>Housing Status</b></td>
                                                                    <td colSpan="2">{this.state.data.otherDetail.HousingStatus}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td colSpan="2"><b>Company</b></td>
                                                                    <td colSpan="2">{this.state.data.otherDetail.Company}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td colSpan="2"><b>Designation</b></td>
                                                                    <td colSpan="2">{this.state.data.otherDetail.Designation}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td colSpan="2"><b>Annual income</b></td>
                                                                    <td colSpan="2">{this.state.data.otherDetail.AnnualIncome}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td colSpan="2"><b>Chequin Accounts</b></td>
                                                                    <td colSpan="2">{this.state.data.otherDetail.ChequinAccount}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td colSpan="2"><b>Other Loans</b></td>
                                                                    <td colSpan="2">{this.state.data.otherDetail.OtherLoan}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td colSpan="2"><b>Monthly Rent/Mortgage</b></td>
                                                                    <td colSpan="2">{this.state.data.otherDetail.MonthlyMortgages}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td><b>Closer Notes</b></td>
                                                                    <td colSpan="4">{this.state.data.CloserNotes === undefined ? "nill" : this.state.data.CloserNotes}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td><b>Agent Notes</b></td>
                                                                    <td colSpan="4">{this.state.data.Notes}</td>
                                                                </tr>
                                                            </tbody>
                                                        </Table>
                                                        :
                                                        <Table responsive bordered style={{ textAlign: "center" }}>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td><b>Cell</b></td>
                                                                    <td>{this.state.viewSale.cell === "" ? "Not Provided" : this.state.data.cell}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td><b>Address</b></td>
                                                                ...
                                                                <tr>
                                                                    <td><b>Email</b></td>
                                                                    <td>{this.state.viewSale.email === "" ? "Not Provided" : this.state.data.email}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td><b>DOB</b></td>
                                                                    <td>{this.state.viewSale.dob}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td><b>MMN</b></td>
                                                                ...
                                                                <tr>
                                                                    <td colSpan="2"><b>Employment Status</b></td>
                                                                    <td colSpan="2">{this.state.viewSale.EmploymentStatus}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td colSpan="2"><b>Housing Status</b></td>
